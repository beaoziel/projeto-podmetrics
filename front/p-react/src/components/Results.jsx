      ...
      <div id='container-modal-charts'>
        ...
        <div id='row1'>  
          ...
          <div id='row-1-content'>
            ...
            <h1>Café da Manhã</h1>
            <p>
            Levante da cama com notícias e análises quentinhas no Café da Manhã, o podcast mais importante do seu dia. Em uma parceria entre Folha de S.Paulo e Spotify, os jornalistas Magê Flores, Maurício Meireles e Bruno Boghossian trazem nas manhãs de segunda a sexta,
             de forma leve e simples, o fundamental... <span>Saiba mais</span>
            </p>
        ...
        <div id='row2'> 
              ...
              <button className='btn'>Chart Completo <img src={Download}></img></button>
             ...
             {cardsData.map((card)=>
                ...
                <div className='card'>
                      <div className='content'>
                            <img src={card.Image} id='logo' onClick={() => setModalOpen(true)}/>
                            ...
                            <div id='info-content'> 
                              ...
                              <h4> {card.Name}</h4>
                              <h6> {card.Description} / {card.Performer}</h6>
                              </div>
